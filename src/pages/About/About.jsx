...
const About = () => {
  return (
    <>
      <PageMeta
        title="About | A S M Saim"
        description="Learn more about A S M Saim, a React Developer with a background in Computer Science & Engineering and a passion for building modern web applications."
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-base sm:text-lg text-gray-400 leading-relaxed">
              ...
              are not just visually appealing, but genuinely easy and enjoyable
              to use.
            </p>

            <p className="text-base sm:text-lg text-gray-400 leading-relaxed">
              I work primarily with React, JavaScript, and modern front-end
              tools, and I care a lot about the small details — smooth
              interactions, responsive layouts, and code that stays easy to read
              and maintain as projects grow.
            </p>
            ...
            <p className="text-base sm:text-lg text-gray-400 leading-relaxed">
              I'm currently looking for opportunities to apply what I've
              learned, contribute to real projects, and keep growing alongside
              people who care about quality and collaboration.
            </p>
          </div>
